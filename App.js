...
//const element = React.createElement("h1",{"id":"heading"},"Namaste React✈️");

//JSX element
const element  = (<h1 className="heading" tabIndex="3">
    Namaste React from JSX✈️✈️
    </h1>)
...
const Heading =()=>(
    <>
      ...
      {Navbar()}
      {a + a}
      <h1 id="heading">Namaste React Heading with functional component</h1>
      {element}
    </>
...
const Header = () => (
  <div className="container">
    ...
    <img src="https://tamilnaducouncil.ac.in/wp-content/uploads/2020/04/dummy-avatar.jpg" />
  </div>
);
